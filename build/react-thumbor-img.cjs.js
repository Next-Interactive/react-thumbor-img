...
var ThumborContext = React.createContext(defaultSettings);
...
function ThumborConfiguration(props) {
  ...
  return React__default.createElement(ThumborContext.Provider, {
    value: settings
  }, children);
}
...
function ThumborImage(_ref) {
  ...
  var settings = React.useContext(ThumborContext);
